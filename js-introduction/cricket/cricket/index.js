...
console.log("Most fours = "+most_fours);
console.log("Most fours player name = "+ most_four_player);

console.log("Most six = "+most_sixes);
console.log("Most six player name = "+most_six_player);

console.log("Most runs = "+most_runs);
console.log("Most runs player name = "+most_runs_player);

console.log("Most wickets = "+most_wickets);
console.log("Most wicket player name = "+most_wicket_player);